                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="font-semibold">+54 9 3525 480179</div>
                      </div>
                    ...
                    >
                      ...
                      <div>
                        <div className="text-sm font-medium opacity-80">Escribinos por WhatsApp</div>
                        <div className="font-semibold">+54 9 3525 480178</div>
                      </div>
                      <ArrowRightIcon className="ml-auto w-5 h-5 opacity-50 group-hover:opacity-100 transition-opacity" />
                    </a>
                    ...
                    >
                      ...
                      <div>
                        <div className="text-sm font-medium opacity-60">Seguinos en Instagram</div>
                        <div className="font-semibold">@megafardosdelnorte</div>
                      </div>
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-sm leading-relaxed max-w-md">
                ...
                desde 2013. De Jesús María al mundo.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>Jesús María, Córdoba, Argentina</li>
                <li>
                  <a href="https://wa.me/543525480179" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold-light transition-colors">
                    +54 9 3525 480179
                  </a>
                </li>
                <li>
                  <a href="https://wa.me/543525480178" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold-light transition-colors">
                    +54 9 3525 480178
                  </a>
                </li>
                <li>
                  <a href="https://www.instagram.com/megafardosdelnorte/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold-light transition-colors">
                    @megafardosdelnorte
                  </a>
                </li>
                <li>
